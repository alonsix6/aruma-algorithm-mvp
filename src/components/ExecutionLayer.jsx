import { Zap, PlayCircle, DollarSign, Activity, Banknote } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium flex items-center gap-1">
              <DollarSign className="w-3 h-3" /> Inversión: USD
            </span>
            <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium flex items-center gap-1">
              <Banknote className="w-3 h-3" /> Revenue: PEN
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
            <p className="text-white/80 text-sm mb-1 flex items-center gap-1">
              Inversión Total Hoy <DollarSign className="w-4 h-4" />
            </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5">
            <p className="text-white/80 text-sm mb-1 flex items-center gap-1">
              Revenue <Banknote className="w-4 h-4" />
            </p>
